...
public class UserDeletePetition extends TagSupport{
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	static Logger logger = Logger.getLogger(UserDeletePetition.class);     
    ...
    public int doStartTag() throws JspException {
        ...
        try {
			...
			out.print("<hr />");
			out.print("<INPUT type=\"submit\" value=\"Go to head page.\">");
		} catch (IOException e) {
